<template>
  <div class="m-bg">
    <van-row class="m-header">
      ...
      <van-col span="20" style="text-align:center">太湖观音</van-col>
    ...
    <van-row>
        ...
        <van-col span="20">
            ...
            <p class="m-p"> 江南石窟内为坐高21.9米的太湖观音，为六道中救度人间众生的准提观音。观音圣像结跏趺坐于出水莲花上，下有二位龙王支撑，善财童子和小龙女协侍左右，感应极大。</p>
            <img src="../../../assets/jd9.png" class="m-img">
        </van-col>
