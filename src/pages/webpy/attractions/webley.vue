<template>
  <div class="m-bg">
    <van-row class="m-header">
      ...
      <van-col span="20" style="text-align:center">蓼莪源</van-col>
    ...
    <van-row>
        ...
        <van-col span="20">
            ...
            <p class="m-p">“蓼莪”两字取自于《诗经·小雅》中的蓼莪篇，是古人对孝的理解的最早记载。蓼莪源恰似一个中国传统庭院，两侧各有一条文化长廊延伸至园区内，
                向游客展示孝文化的发展历程与孝文化经典名句。</p>
            <img src="../../../assets/jd3.png" class="m-img">
        </van-col>
